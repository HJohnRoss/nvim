...
-- Ensure automatic indentation works as expected
...
require('lazy').setup({
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      -- Optional: Set transparent background for Normal and NormalFloat
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'razor', 'sql', 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
